	...
	@if($receipt_details->show_barcode || $receipt_details->show_qr_code)
		<div class="@if(!empty($receipt_details->footer_text)) col-xs-4 @else col-xs-12 @endif text-center">
			@if($receipt_details->show_barcode)
				{{-- Barcode --}}
				<img class="center-block" src="https://goldledgers.com/qrcode2.php?s=	{{$receipt_details->display_name}}&x={{$receipt_details->tax_info1}}&t={{$receipt_details->invoice_date}}&a={{$receipt_details->total}}&v={{$receipt_details->tax}}">
			@endif
			...
			@endphp
				...
				<img class="center-block mt-5" src="https://goldledgers.com/qrcode2.php?s=	{{$receipt_details->display_name}}&x={{ $receipt_details->tax_info1 }}&t={{$receipt_details->invoice_date}}&a={{$receipt_details->total}}&v={{$receipt_details->tax}}">
			@endif
		</div>
	@endif
</div>
